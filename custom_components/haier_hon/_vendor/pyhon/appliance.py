...
from custom_components.haier_hon._vendor.pyhon import diagnose, exceptions
from custom_components.haier_hon._vendor.pyhon.appliances.base import ApplianceBase
from custom_components.haier_hon._vendor.pyhon.attributes import HonAttribute
from custom_components.haier_hon._vendor.pyhon.command_loader import HonCommandLoader
from custom_components.haier_hon._vendor.pyhon.commands import HonCommand
...
from custom_components.haier_hon._vendor.pyhon.typedefs import Parameter

if TYPE_CHECKING:
    from custom_components.haier_hon._vendor.pyhon import HonAPI
    ...
    def __init__(
        ...
        try:
            self._extra: Optional[ApplianceBase] = importlib.import_module(
                f"custom_components.haier_hon._vendor.pyhon.appliances.{self.appliance_type.lower()}"
            ).Appliance(self)
